...
- Updated: 2026-08-25 (G-8 DQ depth closed: quarantine/DLQ write path + built-in 6-check library behind existing seam, 6 new quality env-vars centralized in manifest, 20 DQ tests green, CMM §11 3 rows promoted to 🟢 Production.)
- Owner: maintainer
