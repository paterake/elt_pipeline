# Implementation Backlog (Archived)
...
- stay within scope for bug fixes, hardening, and documentation corrections, or
- add/expand a PRD first, then update the backlog, then implement.
