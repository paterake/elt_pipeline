...
This file is the completed snapshot of the Spark correction backlog. It is kept for historical continuity; see `docs/todo/TODO_SPARK.md` for the current archived pointer.
